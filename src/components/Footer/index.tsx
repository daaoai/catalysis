            ...
            {Object.entries(FooterContent.navigation).map(
              ([section, links]) => (
                <div key={section} className="flex flex-col space-y-4">
                  <h3 className="text-gray-900 dark:text-gray font-semibold font-generalsans text-base">
                    {section}
                  </h3>
                  <ul className="space-y-1">
                    {links.map((link) => (
                      <li key={link.label}>
                        <Link
                          href={link.url}
                          className="text-gray-700 font-generalsans dark:text-white-40 hover:text-gray-900 dark:hover:text-white text-[14px] font-light"
                        >
                          {link.label}
                        </Link>
                      </li>
