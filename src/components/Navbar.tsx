...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 md:w-1/2 bg-[rgba(239,239,239,0.75)] dark:bg-[rgba(28,28,26,0.75)] backdrop-blur-md backdrop-saturate-150 text-white px-10 py-4 rounded-full flex items-center justify-between z-50">
